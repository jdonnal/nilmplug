...
def read_command_reg(wemo):
    ...
    time.sleep(0.01)
    #clear the address
    wemo_write(wemo,[0xA0])
    time.sleep(0.01)
    #set the target address
    wemo_write(wemo,[0xA3,0x24,0x00])
    time.sleep(0.01)
    #clear flash data 
    #wemo_write(wemo,[0xD3,0x04,0xC2,0xAC])
    #read the target address
    wemo_write(wemo,[0xE3])
    time.sleep(0.01)
    #read it again
    wemo_write(wemo,[0xE3])
    time.sleep(0.01)
    ...
    wemo_write(wemo,[0xE3])
    time.sleep(0.01)
    #no unselect the device
    
#    wemo_write(wemo,[0xD3,0x00,0xC0,0xAC])
    time.sleep(0.01)
#    wemo_write(wemo,[0xD3,0xAC,0xC0,0x00])
